  ...
  forbidden: [
    {
      ...
      severity: 'error',
      comment: 'Only imports from index.ts are allowed.',
      from: {
        path: '^src/([^/]+)/.+'
      },
    ...
    },
    {
      name: 'clean-app',
      severity: 'error',
      comment: 'The app layer should only depend on the domain layer.',
      from: {
        path: '^src/app/'
      },
      to: { path: '^src/', pathNot: ['^src/domain', '^src/app'] }
    },
    {
      name: 'clean-domain',
      severity: 'error',
      comment: 'The domain layer should not depend on other parts of the system.',
      from: {
        path: '^src/domain/'
      },
...
// generated: dependency-cruiser@13.0.2 on 2023-05-27T19:51:00.153Z
